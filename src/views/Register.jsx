...
const Register = () => {
  ...
  return (
    <div className="relative z-10 pt-32 pb-10 px-3  min-h-screen bg-hero  flex items-center justify-center lg:gap-7 bg-cover bg-center">
      <img
        src={Globos}
        alt="globos aeroestaticos"
