  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<Layout />}>
        ...
        <Route path="/reseñas/:id" element={<Reviews />} />
        <Route path="/login" element={<Login />} />
        <Route path="/profile" element={<Profile />} />
        <Route path="/productos-favoritos" element={<FavoritesProducts />} />
        ...
        <Route element={<ProtectedBookingRoute />}>
          <Route path="/reservar-informacion" element={<Booking />}>
            <Route path="confirmacion" element={<SuccessBooking />} />
          </Route>
        </Route>
        <Route path="/reserva-confirmada" element={<ConfirmBooking />} />
      </Route>
    </Routes>
  );
}
